...
export default async function NewSchedulingPage({
  ...
  if (!user) {
    redirect("/login?redirectTo=/dashboard/scheduling/new");
  }
    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight">Create scheduling task</h1>
          <p className="mt-2 text-sm text-black/60 dark:text-white/60">
            Prepare the timeline data for the Gantt scheduler.
          </p>
        </div>
        <Link
            ...
            {organizations.map((o) => {
              ...
              return (
                <Link
                  ...
                  href={`/dashboard/scheduling/new?organizationId=${encodeURIComponent(o.id)}`}
